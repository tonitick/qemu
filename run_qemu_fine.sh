...
ws_dir=/home/zhong/proj/bind/Morpheus/output_function_semantics/0x08109bf0/collected_data/path_id_0_len_3/stage_5
...
./qemu-system-arm --plugin tests/tcg/plugins/libvirtual.so,virtual=${ws_dir}/virtuals.txt,modifier=${ws_dir}/modifier.txt,func_start_args=${ws_dir}/fstart_rand_setting.json,args=${ws_dir}/rand_setting.json,outs=${ws_dir}/out_setting.json,function_starts=${ws_dir}/function_start.txt,function_ends=${ws_dir}/function_ends.txt,sub_semantic_start=${ws_dir}/sub_semantic_start.txt,sub_semantic_end=${ws_dir}/sub_semantic_end.txt,dump_path=${ws_dir}/collected_data,sub_semantics_mode=1,sub_semantic_last_stage=1 \

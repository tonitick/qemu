...
##### gs3
# run --plugin ./tests/tcg/plugins/libvirtual.so,virtual=ws/gs3_config/virtuals.txt,detour=ws/gs3_config/detours.txt,modifier=ws/gs3_config/modifiers.txt,args=ws/gs3_config/rand_setting.json,outs=ws/gs3_config/out_setting.json,basicblocks=ws/gs3_config/bb.txt,dump_path=../abc \
...
run --plugin ./tests/tcg/plugins/libvirtual.so,virtual=ws/virtuals.txt,detour=ws/detours.txt,modifier=ws/modifiers.txt,args=ws/rand_setting.json,outs=ws/out_setting.json,basicblocks=ws/bb.txt,dump_path=../abc \
    ...
    -object memory-backend-file,id=ram0,mem-path=/dev/shm/my_m4_ram3_zz,size=512M,share=on -object memory-backend-file,id=ram1,mem-path=/dev/shm/my_m4_ram_zz,size=512K,share=on \
    -global cortexm-soc.shram_backend=ram1  -global cortexm-soc.ram_baseaddr=0x20000000  -global cortexm-soc.shram_baseaddr=0x30000000 \
    -cpu cortex-m7 -device loader,file=../ws/rover2.bin,addr=0x08000000 -global armv7m.init-nsvtor=0x08100000 \
    -serial stdio -nographic -gdb tcp::1235 -S
